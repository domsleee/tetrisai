...
struct MoveFinderConstraintResolver {
  static FirstMoveConstraintT getConstraint(const MyMoveFinder &mf, const BitPieceInfo &chosenPieceInfo) {
...
struct MoveFinderConstraintResolver<MoveFinderFSM> {
  static FirstMoveConstraintT getConstraint(const MoveFinderFSM &mf, const BitPieceInfo &chosenPieceInfo) {
